...
exports.getUpdateAllParas = exports.getUpdateParas = void 0;
/*
...
*/
function getUpdateParas(owner, operators, tokens, op) {
...
exports.getUpdateParas = getUpdateParas;
/*
...
op: String "add" or "remove"
*/
function getUpdateAllParas(owner, operators, op) {
    var operator_length = operators.length;
    var txs = new Array();
    for (var i = 0; i < operator_length; i++) {
...
exports.getUpdateAllParas = getUpdateAllParas;
console.log(JSON.stringify(getUpdateParas('tz1P9k2ZzJyicfpBitM9D4FjjyaUwFH9oT9i', ['addr1', 'addr2'], [1, 2], "add"), null, 2));
console.log(JSON.stringify(getUpdateAllParas('tz1P9k2ZzJyicfpBitM9D4FjjyaUwFH9oT9i', ['addr1', 'addr2'], "remove"), null, 2));
