import { BatchOperation, ContractMethod, ContractProvider, OperationBatch, TezosToolkit, TransactionOperation } from '@taquito/taquito';
...
export interface ContractApi {
     ...
     */
    with: <I extends ContractApi, O>(this: I, createApi: (contract: Tzip12Contract, lambdaView?: address) => O) => I & O;
}
/**
 ...
 * contract
 */
export declare const tezosApi: (tzt: TezosToolkit, lambdaView?: string | undefined) => TezosApi;
/**
 ...
 * ```
 */
export declare const runMethod: (cm: ContractMethod<ContractProvider>) => Promise<TransactionOperation>;
/**
 ...
 * ```
 */
export declare const runBatch: (batch: OperationBatch) => Promise<BatchOperation>;
//# sourceMappingURL=tezos-api.d.ts.map